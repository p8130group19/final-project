...
```
Education seems to play a role in many sections of this data and it seems to be where the strongest signatures come from. Behavioral data should be added along with smoking rates.
